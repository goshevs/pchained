...
|                | default: 0 |
| *MERGOptions*  | merge options to be passed on to *-merge-* upon merging the imputed data with the original data; updated dataset is *master*, original dataset is *using* |
|                | default: *keep(match)* |
